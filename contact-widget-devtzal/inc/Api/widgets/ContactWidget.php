                    ...
                    <div class="row text-center">
                        ...
                        <div>
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <!-- <label for="name">Name</label> -->
                                    <select id="country" class=" form-control selectpicker countrypicker" data-live-search="true" data-default="United States" data-flag="false" placeholder="País"></select>
                                </div>
                             <div class="pt-2 pb-2">
                        ...
                        <div class="btn-group widget-devtzal-btn" role="group" aria-label="Basic mixed styles example" id="contact-buttons">
                            ...
                            if( !empty($instance['phone']) )
                            {
                                echo '<a type="button" class="btn btn-primary widget-button" href="tel:'.$instance['phone'].'"> Llamar <i class="fa fa-phone" aria-hidden="true"></i></a>';
                            }
